...
export default class TopBarNav extends React.Component {
  ...
  render() {
    ...
    return (
	 ...
	 <View>
                <Image style={{height:25, width:25, resizeMode: 'contain', marginLeft:0, position: 'absolute', top: -2, left: -55}} source={icon} />
         </View>
          <View
            style={{ flexDirection: 'row' }}>
{/*	    <Image style={{flex: 1, height:25, width:25, resizeMode: 'contain', marginLeft:0}} source={icon} /> */}
